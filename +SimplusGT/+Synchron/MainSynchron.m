...
Gbus = SimplusGT.MatrixTwist(Ybus,NumIbus1st);
% GbusVI  = Gbus;
% GbusVIF = SimplusGT.MatrixTwist(YbusVIF,NumIbus1st);

% For numerically calculating GbusPrime later
Gbus_ = SimplusGT.MatrixTwist(Ybus_,NumIbus1st);
...
% Get fault Gbus
GbusFault = SimplusGT.MatrixTwist(YbusFault,NumIbus1st);
GbusFault = - GbusFault;
