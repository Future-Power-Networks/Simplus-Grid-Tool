...
% this way avoids using  'cd', in case 'cd' is not set correctly at theGmObj_Cell
% toolbox.
...
[AutoSelResult] = SimplusGT.Modal.ExcelWrite(NumBus, NumApparatus,ApparatusType,ApparatusBus,...
    ApparatusStateStr,ZbusStateStr, GsysSs, GsysDss, MdAutoSel, Fbase, UserdataModal);
