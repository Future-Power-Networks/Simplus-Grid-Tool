...
classdef GridFollowingVSI_old < SimplusGT.Class.ModelAdvance
    ...
    methods
        % constructor
        function obj = GridFollowingVSI_old(varargin)
    ...
    methods(Static)
        ...
        function [State,Input,Output] = SignalList(obj)
            ...
            if (obj.ApparatusType == 18) || (obj.ApparatusType == 12)
