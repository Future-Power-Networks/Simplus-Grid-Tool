...
% 1. You MUST add this folder and all subfolders to the path before running this program. 
...
% '\StepResponsePlot\StepPlot.m' to plot my saved data.
...
% generated autmatically in 'NetworkConfigData'. Then you have to select
