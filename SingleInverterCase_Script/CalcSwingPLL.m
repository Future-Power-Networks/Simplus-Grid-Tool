...
function [Y_PLL,Ytot_prime,Svt,Svt_prime,root,root_prime,pole_sys,Gi_cl] = CalcSwingPLL(varargin)
...
for i = 1:length(varargin)
	...
	elseif (strcmpi(varargin{i},'Rline'))
        Rline = varargin{i+1};
    elseif (strcmpi(varargin{i},'w_pll'))
        w_pll = varargin{i+1};
    elseif (strcmpi(varargin{i},'V'))
        V = varargin{i+1};
    elseif (strcmpi(varargin{i},'I'))
        I = varargin{i+1};
    elseif (strcmpi(varargin{i},'w_i'))
        w_i = varargin{i+1};
