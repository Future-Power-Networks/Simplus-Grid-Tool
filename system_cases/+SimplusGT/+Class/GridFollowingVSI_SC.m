...
classdef GridFollowingVSI_SC < SimplusGT.Class.ModelAdvance
    ...
    methods
        % constructor
        function obj = GridFollowingVSI_SC(varargin)   
    ...
    methods(Static)
        ...
        function [State,Input,Output] = SignalList(obj)
            ...
            % correspondingly.
            if (obj.ApparatusType == 10) || (obj.ApparatusType == 12) || (obj.ApparatusType == 19)
        ...
        function [Output] = StateSpaceEqu(obj,x,u,CallFlag)
            ...
            if obj.Timer>10 % At 10 seconds, the rated power is increased by 1.3 of original valeus
                wLf = wLf/1.5;
                R = R/1.5;
                C_dc = C_dc*1.5;
            end
            ...
            % Dc link control
          	if obj.ApparatusType == 10 || obj.ApparatusType == 19
