...
t_length =1.5; % length of data in second
...
vdq_d=timeseries2timetable(vdq2_d{1}.Values);
vdq_q=timeseries2timetable(vdq2_q{1}.Values);

vdq_dq_all = synchronize(vdq_d, vdq_q);
...
vdq_dq_trim(:,1).Variables=vdq_dq_trim(:,i).Variables-raw_data(2.95*Fs,i);
