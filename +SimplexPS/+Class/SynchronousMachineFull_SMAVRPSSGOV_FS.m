...
% This is a modified version to faster stabilize the system:
% At the first 5 second, the damping torque coefficient D of the machine is
% deliberately set as a high value to stabilize the system quickly. then
% after T=5s, D was set back.
...
classdef SynchronousMachineFull_SMAVRPSSGOV_FS < SimplexPS.Class.ModelAdvance
    ...
    methods
        % constructor
        function obj = SynchronousMachineFull_SMAVRPSSGOV_FS(varargin)
    ...
    methods(Static)
        ...
        function [State,Input,Output] = SignalList(obj)
          ...
          State = {'id','iq','w','theta','Ed1','Eq1','Psi1d','Psi2q',...
              'Efd','Vr','Rf','Va','Vx1','Vx2','Vss1','Vss2','Vss3','Vss'...
              'G2','G3','T_m'};%'Rssw','Rss1','Rss2','Rss3'};
          Input	 = {'v_d','v_q','Tref','Vref'};
        ...
        function [x_e,u_e,xi] = Equilibrium(obj)
            ...
            x_e = [i_d; i_q; w; theta; Ed1; Eq1; Psi1d; Psi2q; ...
                Efd; Vr; Rf; Va; Vx1; Vx2; Vss1; Vss2; Vss3; Vss; G2; G3; T_m];%Rssw, Rss1, Rss2, Rss3];
