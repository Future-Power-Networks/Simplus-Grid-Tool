...
function plot_c(Xw,fbd,varargin)
    ...
    [LineWidth,~]  = SimplexPS.LoadVar(1.5,'LineWidth',varargin);
    [LineStyle,~]  = SimplexPS.LoadVar('-','LineStyle',varargin);
    [Color,~]      = SimplexPS.LoadVar([],'Color',varargin);
    [PhaseOn,~]    = SimplexPS.LoadVar(1,'PhaseOn',varargin);
    [PhaseShift,~] = SimplexPS.LoadVar(0,'PhaseShift',varargin);
