...
%% Load saved data
GsysDSS_5Hz  = load('GsysDSS_VSI5Hz_InfBus.mat').GsysDSS;
GsysDSS_10Hz = load('GsysDSS_VSI10Hz_InfBus.mat').GsysDSS;
GsysDSS_15Hz = load('GsysDSS_VSI15Hz_InfBus.mat').GsysDSS;
GsysDSS_20Hz = load('GsysDSS_VSI20Hz_InfBus.mat').GsysDSS;
GsysDSS_25Hz = load('GsysDSS_VSI25Hz_InfBus.mat').GsysDSS;
