...
classdef GridFollowingVSI_dist < SimplusGT.Class.ModelAdvance
    ...
    methods(Static)
        ...
        function [Output] = StateSpaceEqu(obj,x,u,CallFlag)
            ...
            % ###
            % DC-link bandwidth disturbance
%             if (obj.Timer >= 6) && (obj.Timer <= 6.1)
%                 f_v_dc = 30;
%             end
...
%             end
            ...
            % ###
            % Ac current bandwidth disturbance
%             if (obj.Timer >= 6) && (obj.Timer <= 6.1)
%                 f_i_dq = 150;
%             end
