...
function Xw = bodec(X,sbd,wbase,varargin)
    ...
    [LineWidth,~] = LoadVar(1.5,'LineWidth',varargin);  % Default 1.5
    ...
    if PlotOn == 1
        plotc(Xw,imag(sbd)/wbase,'PhaseOn',PhaseOn,'PhaseShift',PhaseShift,'LineWidth',LineWidth,'Color',Color,varargin);
    else
