...
set(gca,'XLim',XLim);
set(gca,'XTick',XTick);
set(gca,'YLim',[0.8,1.02]);
set(gca,'YTick',[0.96,1,1.02]);
...
set(gca,'YTick',[0.6,1,1.1]);
ylabel({'$\omega_8$ (pu)'},'interpreter','latex')
xlabel({'Time (s)'},'interpreter','latex');
plot([xtick1,xtick1],YLim_w,'--k'); hold on; grid on;

if 1
    print(gcf,'Sim_Transient_GFL_Stable.png','-dpng','-r600');
end