...
if hex2dec(version('-release')) < hex2dec('2018b')
    delete(bar);
    StopInstall('Error: Please use Matlab 2018a or later version!');
    return;
end
...
load_system('SimplusGT_2018a.slx');
save_system('SimplusGT_2018a.slx','Library/SimplusGT.slx');
